...
<div id="main-content">
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2 class="lead"><b>Update Profile</b></h2>
                ...
                <div class="body">
                    <form class="form-auth-small" method="POST" action="{{ route('profile.update') }}"
                        ...
                        <div class="form-group c_form_group">
                            <label>Image</label>
                            <input type="file" name="image" class="form-control" placeholder="Enter your Image"
                                value="{{ old('image') }}">
                            @if ($errors->has('image'))
