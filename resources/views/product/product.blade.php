                                ...
                                <table class="table  table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($product as $product)
                                            <tr>
                                                <td><input type="checkbox" class="record-checkbox" name="record_ids[]"
                                                        value="{{ $product->id }}"></td>
                                                <td>{{ $product->id }}</td>
                                                <td><img src="{{ url('/images/' . $product->image) }}" class="rounded-circle"
                                                        width="80" height="80"></td>
                                                <td>{{ $product->name }}</td>
                                                <td>{{ $product->description }}</td>
                                                <td>
                                                    <a href="/product/edit/{{ $product->id }}"
                                                        class="btn btn-outline-secondary btn-md"><i
                                    ...
                                    <button type="button" onclick="return confirm('Are you sure to delete this ?')" class="btn btn-outline-danger btn-md" id="deleteSelected">Delete
                                        Selected</button>
